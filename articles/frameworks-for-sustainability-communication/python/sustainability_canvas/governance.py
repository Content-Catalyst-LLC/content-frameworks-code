"""Governance transformations for Sustainability Communication Catalyst Canvas exports."""
...
def queue_item(result: AuditResult) -> dict[str, object]:
    return {
        "queue_id": f"sustainability-claim-review-{slugify(result.claim)}",
        "article_slug": "frameworks-for-sustainability-communication",
        "claim": result.claim,
