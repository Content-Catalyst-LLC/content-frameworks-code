...
This article folder includes a Canvas-ready Sustainability Communication module.
...
- package-style Python under `python/sustainability_canvas/`
...
- `outputs/json/sustainability_canvas_export.json` for the complete audit payload
