...
/**
 * Lightweight Java smoke validator for Persona Frameworks Catalyst Canvas outputs.
 * This intentionally uses only the Java standard library.
 */
public class PersonaCanvasValidator {
    public static void main(String[] args) throws IOException {
        ...
        if (!manifestText.contains("\"persona_canvas\"")) {
            throw new IllegalStateException("Manifest does not identify persona_canvas.");
        }

        System.out.println("Persona Canvas Java validation passed.");
    }
