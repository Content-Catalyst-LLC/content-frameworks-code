...
This article folder includes a Canvas-ready Persona Frameworks module.
...
- package-style Python under `python/persona_canvas/`
...
- `outputs/json/persona_canvas_export.json` for the complete audit payload
