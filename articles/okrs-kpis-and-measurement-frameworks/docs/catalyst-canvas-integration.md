...
This article folder includes a Canvas-ready OKR KPI Measurement Frameworks module.
...
- package-style Python under `python/measurement_canvas/`
...
- `outputs/json/measurement_canvas_export.json` for the complete audit payload
