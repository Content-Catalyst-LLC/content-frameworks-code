# OKRs, KPIs, and Measurement Frameworks

Companion code for the Content Frameworks article **“OKRs, KPIs, and Measurement Frameworks.”**
...
```bash
PYTHONPATH=python python3 -m measurement_canvas.cli --article-root .
```

Or:

```bash
python3 python/run_measurement_canvas_audit.py
```
...
- `outputs/tables/measurement_canvas_audit.csv`
- `outputs/json/catalog.json`
- `outputs/json/canvas_cards.json`
- `outputs/json/governance_queue.json`
- `outputs/json/measurement_canvas_export.json`
- `outputs/markdown/governance_queue.md`

## Purpose

The module treats OKRs KPIs and measurement frameworks as auditable governance assets. It evaluates measurement type, strategic relevance, validity, reliability, actionability, timeliness, evidence strength, gaming risk, reporting burden, ambiguity, evidence gaps, measurement risk, governance priority, and review status.
