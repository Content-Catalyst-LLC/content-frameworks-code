...
This article folder includes a Canvas-ready Audience Journey module.
...
- package-style Python under `python/audience_journey_canvas/`
...
- `outputs/json/audience_journey_canvas_export.json` for the complete audit payload
