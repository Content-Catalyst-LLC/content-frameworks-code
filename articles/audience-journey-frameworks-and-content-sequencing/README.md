...
Companion code for the Content Frameworks article **“Audience Journey Frameworks and Content Sequencing.”**
...
```bash
python3 python/run_audience_journey_canvas_audit.py
```
...
The module treats audience journey frameworks as auditable content-framework assets. It evaluates stage clarity, content coverage, transition quality, evidence readiness, governance readiness, link gaps, persona fit, staleness risk, journey risk, and review priority.
