...
/**
 * Lightweight Java smoke validator for Audience Journey Catalyst Canvas outputs.
 * This intentionally uses only the Java standard library.
 */
public class AudienceJourneyCanvasValidator {
    public static void main(String[] args) throws IOException {
        ...
        if (!manifestText.contains("\"audience_journey_canvas\"")) {
            throw new IllegalStateException("Manifest does not identify audience_journey_canvas.");
        }

        System.out.println("Audience Journey Canvas Java validation passed.");
    }
