...
This article folder includes a Canvas-ready Technology and Scientific Communication module.
...
- package-style Python under `python/technology_science_canvas/`
...
- `outputs/json/technology_science_canvas_export.json` for the complete audit payload
