...
This article folder includes a Canvas-ready PESTLE Analysis module.
...
- package-style Python under `python/pestle_canvas/`
...
- `outputs/json/pestle_canvas_export.json` for the complete audit payload
