...
This article folder includes a Canvas-ready Scaling Knowledge Through Frameworks module.
...
- package-style Python under `python/knowledge_scaling_canvas/`
...
- `outputs/json/knowledge_scaling_canvas_export.json` for the complete audit payload
