...
This article folder includes a Canvas-ready Logic Models and Theory of Change module.
...
- package-style Python under `python/logic_model_canvas/`
...
- `outputs/json/logic_model_canvas_export.json` for the complete audit payload
