...
Companion code for the Content Frameworks article **“Logic Models and Theory of Change Frameworks.”**
...
```bash
python3 python/run_logic_model_canvas_audit.py
```
...
The module treats logic models and Theory of Change frameworks as auditable causal-governance assets. It evaluates model layer, evidence strength, assumption importance, assumption evidence, measurement coverage, outcome clarity, claim strength, assumption risk, evidence gaps, pathway quality, governance priority, and review status.
