...
This article folder includes a Canvas-ready Systems Explanation module.
...
- package-style Python under `python/systems_explanation_canvas/`
...
- `outputs/json/systems_explanation_canvas_export.json` for the complete audit payload
