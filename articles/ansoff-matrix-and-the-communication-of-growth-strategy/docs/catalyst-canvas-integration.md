...
This article folder includes a Canvas-ready Ansoff Matrix module.
...
- package-style Python under `python/ansoff_canvas/`
...
- `outputs/json/ansoff_canvas_export.json` for the complete audit payload
