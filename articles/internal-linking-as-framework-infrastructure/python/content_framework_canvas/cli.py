...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a Catalyst Canvas readiness audit for a Content Frameworks article.")
    parser.add_argument("--article-root", type=Path, default=Path.cwd())
