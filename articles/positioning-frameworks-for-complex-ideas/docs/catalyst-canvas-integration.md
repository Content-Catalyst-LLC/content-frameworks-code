...
This article folder includes a Canvas-ready Positioning Frameworks module.
...
- package-style Python under `python/positioning_canvas/`
...
- `outputs/json/positioning_canvas_export.json` for the complete audit payload
