...
Companion code for the Content Frameworks article **“Positioning Frameworks for Complex Ideas.”**
...
```bash
PYTHONPATH=python python3 -m positioning_canvas.cli --article-root .
```

Or:

```bash
python3 python/run_positioning_canvas_audit.py
```
...
- `outputs/tables/positioning_canvas_audit.csv`
- `outputs/json/catalog.json`
- `outputs/json/canvas_cards.json`
- `outputs/json/governance_queue.json`
- `outputs/json/positioning_canvas_export.json`
- `outputs/markdown/governance_queue.md`

## Purpose

The module treats positioning complex ideas as an auditable content-framework practice. It evaluates category clarity, audience relevance, differentiation, evidence strength, governance readiness, boundary clarity, ethical risk, drift risk, and revision priorities.
