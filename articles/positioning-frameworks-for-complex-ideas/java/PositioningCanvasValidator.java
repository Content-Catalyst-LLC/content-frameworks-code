...
/**
 * Lightweight Java smoke validator for Positioning Frameworks Catalyst Canvas outputs.
 * This intentionally uses only the Java standard library.
 */
public class PositioningCanvasValidator {
    public static void main(String[] args) throws IOException {
        ...
        if (!manifestText.contains("\"positioning_canvas\"")) {
            throw new IllegalStateException("Manifest does not identify positioning_canvas.");
        }

        System.out.println("Positioning Canvas Java validation passed.");
    }
