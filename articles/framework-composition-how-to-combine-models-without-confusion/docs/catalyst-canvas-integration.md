...
This article folder includes a Canvas-ready Framework Composition module.
...
- package-style Python under `python/framework_composition_canvas/`
...
- `outputs/json/framework_composition_canvas_export.json` for the complete audit payload
