...
/**
 * Lightweight Java smoke validator for Framework Composition Catalyst Canvas outputs.
 * This intentionally uses only the Java standard library.
 */
public class FrameworkCompositionCanvasValidator {
    public static void main(String[] args) throws IOException {
        ...
        if (!manifestText.contains("\"framework_composition_canvas\"")) {
            throw new IllegalStateException("Manifest does not identify framework_composition_canvas.");
        }

        System.out.println("Framework Composition Canvas Java validation passed.");
    }
