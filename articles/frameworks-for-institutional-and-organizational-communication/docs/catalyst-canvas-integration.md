...
This article folder includes a Canvas-ready Institutional and Organizational Communication module.
...
- package-style Python under `python/institutional_communication_canvas/`
...
- `outputs/json/institutional_communication_canvas_export.json` for the complete audit payload
