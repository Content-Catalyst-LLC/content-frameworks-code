"""Governance transformations for Institutional Communication Catalyst Canvas exports."""
...
def queue_item(result: AuditResult) -> dict[str, object]:
    return {
        "queue_id": f"institutional-communication-review-{slugify(result.item)}",
        "article_slug": "frameworks-for-institutional-and-organizational-communication",
        "item": result.item,
