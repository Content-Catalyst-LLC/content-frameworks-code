...
This article folder includes a Canvas-ready Public Reasoning and Framework Design module.
...
- package-style Python under `python/public_reasoning_canvas/`
...
- `outputs/json/public_reasoning_canvas_export.json` for the complete audit payload
