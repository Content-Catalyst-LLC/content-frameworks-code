...
/**
 * Lightweight Java smoke validator for Public Reasoning and Framework Design Catalyst Canvas outputs.
 * This intentionally uses only the Java standard library.
 */
public class PublicReasoningCanvasValidator {
    public static void main(String[] args) throws IOException {
        ...
        if (!manifestText.contains("\"public_reasoning_canvas\"")) {
            throw new IllegalStateException("Manifest does not identify public_reasoning_canvas.");
        }

        System.out.println("Public Reasoning Canvas Java validation passed.");
    }
