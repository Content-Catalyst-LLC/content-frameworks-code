"""Governance transformations for Public Reasoning Catalyst Canvas exports."""
...
def queue_item(result: AuditResult) -> dict[str, object]:
    return {
        "queue_id": f"public-reasoning-review-{slugify(result.item)}",
        "article_slug": "public-reasoning-and-framework-design",
        "item": result.item,
