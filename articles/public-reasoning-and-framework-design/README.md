...
Companion code for the Content Frameworks article **“Public Reasoning and Framework Design.”**
...
```bash
python3 python/run_public_reasoning_canvas_audit.py
```
...
The module treats public reasoning and framework design as an auditable content-governance system. It evaluates claim clarity, evidence visibility, value transparency, tradeoff clarity, stakeholder inclusion, uncertainty disclosure, participation fit, accountability, transparency, legitimacy risk, review priority, and governance status.
