...
This article folder includes a Canvas-ready Porter Five Forces module.
...
- package-style Python under `python/five_forces_canvas/`
...
- `outputs/json/five_forces_canvas_export.json` for the complete audit payload
