...
/**
 * Lightweight Java smoke validator for Porter Five Forces Catalyst Canvas outputs.
 * This intentionally uses only the Java standard library.
 */
public class FiveForcesCanvasValidator {
    public static void main(String[] args) throws IOException {
        ...
        if (!manifestText.contains("\"five_forces_canvas\"")) {
            throw new IllegalStateException("Manifest does not identify five_forces_canvas.");
        }

        System.out.println("Porter Five Forces Canvas Java validation passed.");
    }
