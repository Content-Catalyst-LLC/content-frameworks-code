...
This article folder includes a Canvas-ready The Limits of Framework Thinking module.
...
- package-style Python under `python/framework_limits_canvas/`
...
- `outputs/json/framework_limits_canvas_export.json` for the complete audit payload
