...
/**
 * Lightweight Java smoke validator for The Limits of Framework Thinking Catalyst Canvas outputs.
 * This intentionally uses only the Java standard library.
 */
public class FrameworkLimitsCanvasValidator {
    public static void main(String[] args) throws IOException {
        ...
        if (!manifestText.contains("\"framework_limits_canvas\"")) {
            throw new IllegalStateException("Manifest does not identify framework_limits_canvas.");
        }

        System.out.println("Framework Limits Canvas Java validation passed.");
    }
