...
Companion code for the Content Frameworks article **“The Limits of Framework Thinking.”**
...
```bash
python3 python/run_framework_limits_canvas_audit.py
```
...
The module treats framework limits as an auditable content-governance system. It evaluates clarity, fit, evidence alignment, assumption transparency, governance readiness, oversimplification risk, false precision risk, context loss, audience burden, value opacity, distortion risk, review priority, and governance status.
