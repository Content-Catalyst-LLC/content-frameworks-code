"""Governance transformations for Content Framework Value Catalyst Canvas exports."""
...
def queue_item(result: AuditResult) -> dict[str, object]:
    return {
        "queue_id": f"content-framework-value-review-{slugify(result.item)}",
        "article_slug": "why-content-frameworks-matter-today",
        "item": result.item,
