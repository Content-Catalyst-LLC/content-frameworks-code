...
This article folder includes a Canvas-ready Why Content Frameworks Matter Today module.
...
- package-style Python under `python/content_framework_value_canvas/`
...
- `outputs/json/content_framework_value_canvas_export.json` for the complete audit payload
