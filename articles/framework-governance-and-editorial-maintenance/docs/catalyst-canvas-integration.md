...
This article folder includes a Canvas-ready Framework Governance and Editorial Maintenance module.
...
- package-style Python under `python/framework_governance_canvas/`
...
- `outputs/json/framework_governance_canvas_export.json` for the complete audit payload
