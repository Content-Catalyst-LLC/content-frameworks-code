"""Governance transformations for Strategic Foresight Catalyst Canvas exports."""
...
def queue_item(result: AuditResult) -> dict[str, object]:
    return {
        "queue_id": f"strategic-foresight-review-{slugify(result.item)}",
        "article_slug": "frameworks-for-strategic-foresight-and-scenario-thinking",
        "item": result.item,
