...
This article folder includes a Canvas-ready Strategic Foresight and Scenario Thinking module.
...
- package-style Python under `python/strategic_foresight_canvas/`
...
- `outputs/json/strategic_foresight_canvas_export.json` for the complete audit payload
