<?php
/**
 * WordPress-oriented helper snippets for Content Frameworks governance articles.
 */
...
function cc_content_audit_repository_block($github_url) {
    return '<div class="cc-github-repo-link">'
        . '<strong>Complete Code Repository</strong>'
        . '<p>The full code distribution for this article, including content-audit diagnostics, governance queues, metadata validation, generated outputs, and notebook placeholders, is available on GitHub.</p>'
        . '<a href="' . esc_url($github_url) . '" target="_blank" rel="noopener">View the Full GitHub Repository</a>'
        . '</div>';
}
