...
Companion code for the Content Frameworks article **“BCG Matrix and Portfolio Communication.”**
...
```bash
python3 python/run_bcg_canvas_audit.py
```
...
The module treats the BCG Matrix as an auditable portfolio communication asset. It evaluates portfolio area, growth score, relative share score, quadrant classification, evidence strength, strategic fit, maintenance burden, evidence gaps, portfolio priority, recommended action, governance priority, and review status.
