...
This article folder includes a Canvas-ready BCG Matrix module.
...
- package-style Python under `python/bcg_canvas/`
...
- `outputs/json/bcg_canvas_export.json` for the complete audit payload
