...
This article folder includes a Canvas-ready SWOT Analysis module.
...
- package-style Python under `python/swot_canvas/`
...
- `outputs/json/swot_canvas_export.json` for the complete audit payload
