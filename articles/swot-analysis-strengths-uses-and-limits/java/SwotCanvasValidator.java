...
/**
 * Lightweight Java smoke validator for SWOT Analysis Catalyst Canvas outputs.
 * This intentionally uses only the Java standard library.
 */
public class SwotCanvasValidator {
    public static void main(String[] args) throws IOException {
        ...
        if (!manifestText.contains("\"swot_canvas\"")) {
            throw new IllegalStateException("Manifest does not identify swot_canvas.");
        }

        System.out.println("SWOT Canvas Java validation passed.");
    }
