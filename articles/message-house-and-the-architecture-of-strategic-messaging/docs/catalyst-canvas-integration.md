...
This article folder includes a Canvas-ready Message House module.
...
- package-style Python under `python/message_house_canvas/`
...
- `outputs/json/message_house_canvas_export.json` for the complete audit payload
