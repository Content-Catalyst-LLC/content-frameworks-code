...
/**
 * Lightweight Java smoke validator for Message House Catalyst Canvas outputs.
 * This intentionally uses only the Java standard library.
 */
public class MessageHouseCanvasValidator {
    public static void main(String[] args) throws IOException {
        ...
        if (!manifestText.contains("\"message_house_canvas\"")) {
            throw new IllegalStateException("Manifest does not identify message_house_canvas.");
        }

        System.out.println("Message House Canvas Java validation passed.");
    }
