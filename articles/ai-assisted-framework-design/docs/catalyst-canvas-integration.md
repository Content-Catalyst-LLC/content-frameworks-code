...
This article folder includes a Canvas-ready AI-Assisted Framework Design module.
...
- package-style Python under `python/ai_assisted_framework_design_canvas/`
...
- `outputs/json/ai_assisted_framework_design_canvas_export.json` for the complete audit payload
